    ...
    return (
        <section className="contact section" id="contact">
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">moneyyst399@gmail.com</span>

                            <a href="mailto:yagyasaini555@gmail.com" className="contact__button">
                                Write Me{" "}
                ...
                <div className="contact__content">
                    <h3 className="contact__title">What's Your Review?</h3>
                    {submitted ? (
                        <p className="testimonial__submitted">Thank you! Your review will inspire me to do even better.</p>
                    ) : (
                    <form ref={form} onSubmit={sendReview} className="contact__form">
