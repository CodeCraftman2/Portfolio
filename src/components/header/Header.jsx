...
import './header.css';
import { HiOutlineHome, HiOutlineUser, HiOutlineClipboardList, HiOutlinePhotograph, HiOutlineMail, HiX,HiOutlineViewGrid } from "react-icons/hi";
    ...
    return(
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav__logo">CodeCraftman2</a>
                        ...
                        <li className="nav__item">
                            <a href="#testimonials" onClick={() => setActiveNav("#testimonials")}
                               className={activeNav === "#testimonials" ? "nav__link active-link" : "nav__link"}>
                                <HiOutlineMail className="nav__icon"/>Feedback
                            </a>
                        </li>
                        <li className="nav__item">
